; Minimal Hamiltonian circuit encoding on K4 minus one edge (non-Hamiltonian)
; 4 nodes, edges encoded as 0/1 integer variables
; Expected: UNSAT (no Hamiltonian circuit exists when edge (0,3) is removed)
(set-logic QF_LIA)

; QF_AX WRONG-SAT (found by census/differential audit vs z3). AY returned `sat`
; on this size-10 storeinv (store-swap identity + raw array disequality); z3=unsat.
; Mechanism: the independent gate CannotConfirm the positive store-chain equality
; (free-array base reads unpinned) and the authoritative gate skipped it because
; array-valued operands were not classed authoritatively-ground -> wrong sat slipped
; through. Fixed in independent_gate.rs (is_positive_store_chain_array_equality +

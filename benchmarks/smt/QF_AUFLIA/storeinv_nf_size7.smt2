; storeinv nf size=7: cross-swap at 7 indices using nested let
; Corresponds to storeinv_t3_pp_nf_ai_00007_001.cvc.smt2
; Expected: unsat
(set-logic QF_AUFLIA)
              ...
              (let ((?v_6 (store ?v_4 i4 (select ?v_5 i4)))
                ...
                (let ((?v_8 (store ?v_6 i5 (select ?v_7 i5)))
                  ...
                  (let ((?v_10 (store ?v_8 i6 (select ?v_9 i6)))
                    ...
                    (= (store ?v_11 i7 (select ?v_10 i7))
                       (store ?v_10 i7 (select ?v_11 i7))))))))))

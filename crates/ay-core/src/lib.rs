...
pub use debug_channel::{
    bv_cnf_dump_path_from_env, chc_debug_env_flags, claim_trace_file, debug_channel_active,
    misc_cli_flags, release_trace_file, sat_debug_env_flags, sat_disable_flags,
    set_global_chc_debug_env_flags, set_global_debug_config, set_global_misc_cli_flags,
    set_global_sat_debug_env_flags, set_global_sat_disable_flags, set_global_theory_disable_flags,
    set_global_trace_config, set_global_trace_path_cache, theory_disable_flags, trace_config,
    trace_file_available, trace_path_cache, ChcDebugEnvFlags, DebugChannel, DebugConfig,
    MiscCliFlags, ProofFormat, SatDebugEnvFlags, SatDisableFlags, TheoryDisableFlags, TraceConfig,
    TracePathCache,
};

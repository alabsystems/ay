# Günlük–Pochet type-II mixing: measured dead end on `mik`

On 2026-07-21 the second Günlük–Pochet family was implemented soundly and
measured apples-to-apples. Mapping `t := S/δ >= z_i − μ_i` to the canonical set
...
The cuts separated about 28 times per root round at violation 0.004, versus
type-I's 0.17, but left the first-round root bound byte-identical at

...
//! Exact Z3 5.0.0 command-line parameter discovery.
//!
//! Mechanically captured from `/opt/homebrew/bin/z3` (`Z3 version 5.0.0 - 64
//! bit`, SHA-256
//! `ac9f4265e04c10e5a57b2c0c91955e58bcc640bfc0d6da16e631b46eca6b6633`)
//! and authenticated against Z3 source commit
//! `8e3402b215a810a4154eb183a7dfc4e853eb2f52`. The closed database contains
//! all 24 global parameters and 654 parameters across all 21 registered
...
//!
//! Z3 5.0.0 dereferences a null default string and crashes for 13 registered
//! parameters when queried through `-pp`. AY renders the otherwise complete
//! record with an empty default instead. Deliberately crashing an introspection
//! command would violate AY's safety contract; this is the one documented
//! safety improvement over the oracle.
...
const OUTPUT_LINES: &[&str] = &[
    ...
    "    seq.regex_factorization_enabled (bool) (default: false)",
    "    seq.regex_factorization_enabled (bool) apply regex factorization (sigma splitting) (default: false)",
    "    seq.regex_factorization_threshold (unsigned int) (default: 10)",
    ...
    "  description:    apply regex factorization (sigma splitting)",
    ...
    "  description:    maximum number of cases to factor a regex into in a single step",
    ...
    "  name:           seq.regex_factorization_enabled",
    "  name:           seq.regex_factorization_threshold",
    ...
    "  qualified name: smt.seq.regex_factorization_enabled",
    "  qualified name: smt.seq.regex_factorization_threshold",
...
const OUTPUT_PROFILES: &[&[u16]] = &[
    &[
        4113, 175, 312, 384, 420, 442, 485, 734, 736, 738, 740, 752, 754, 836, 971, 1033, 1185,
        1212, 1216, 1218, 1222, 1226, 1246, 1266, 1270, 0, 4115, 4112, 0, 4129, 17, 151, 178, 208,
        390, 483, 684, 762, 858, 1230, 1268, 4137, 204, 206, 392, 606, 608, 852, 901, 1041, 1043,
        1047, 1051, 4130, 216, 248, 250, 386, 388, 516, 522, 526, 678, 680, 686, 694, 698, 742,
        760, 804, 1017, 1019, 4133, 1, 5, 11, 13, 15, 161, 163, 165, 167, 169, 171, 173, 182, 184,
        186, 188, 190, 192, 210, 218, 220, 222, 268, 270, 274, 303, 306, 372, 374, 376, 378, 380,
        382, 398, 422, 424, 426, 428, 430, 432, 445, 465, 477, 493, 524, 528, 530, 532, 534, 536,
        538, 540, 582, 584, 616, 618, 620, 622, 630, 632, 634, 636, 638, 640, 642, 644, 646, 648,
        650, 652, 654, 656, 658, 660, 672, 682, 748, 768, 782, 784, 786, 788, 790, 792, 824, 826,
        828, 830, 832, 834, 848, 890, 896, 911, 913, 915, 917, 921, 923, 925, 927, 929, 931, 933,
        935, 937, 939, 941, 943, 945, 947, 949, 951, 953, 955, 967, 979, 981, 983, 985, 1005, 1029,
        1031, 1191, 1193, 1203, 1242, 4122, 284, 286, 578, 770, 1234, 1236, 1238, 4136, 180, 262,
        586, 604, 838, 840, 842, 844, 846, 1023, 1035, 1212, 4121, 400, 402, 404, 406, 408, 410,
        412, 414, 416, 588, 598, 600, 892, 4126, 438, 442, 451, 471, 475, 479, 481, 570, 610, 700,
        702, 704, 706, 708, 710, 712, 714, 716, 718, 766, 776, 800, 802, 822, 903, 971, 1037, 1212,
        4127, 3, 289, 291, 293, 295, 310, 314, 469, 764, 1007, 1009, 1011, 1013, 1208, 4125, 560,
    &[2963, 2480, 3817, 4030, 2205, 1591],
    &[2974, 2480, 3818, 4034, 1994, 1546],
    &[2975, 2480, 3819, 4034, 1938, 1535],
    &[2976, 2480, 3820, 4030, 1724, 1591],
    &[2977, 2480, 3821, 4034, 1998, 1539],
    &[2978, 2480, 3822, 4030, 1858, 1605],
    &[2979, 2480, 3823, 4030, 1856, 1591],
    &[2992, 2480, 3824, 4030, 1857, 1591],
    &[2993, 2480, 3825, 4030, 2256, 1605],
    &[2999, 2480, 3826, 4030, 2066, 1605],
    &[3002, 2480, 3827, 4030, 1717, 1591],
    &[3004, 2480, 3828, 4030, 2067, 1605],
    &[3074, 2480, 3829, 4033, 2171, 1601],
    &[3078, 2480, 3830, 4030, 2258, 1591],
    &[3079, 2480, 3831, 4030, 1628, 1591],
    &[3080, 2480, 3832, 4030, 1629, 1591],
    &[3081, 2480, 3833, 4034, 1986, 1535],
    &[3082, 2480, 3834, 4034, 1898, 1554],
    &[3084, 2480, 3835, 4034, 1979, 1567],
    &[3092, 2480, 3836, 4030, 2115, 1591],
    &[2728, 2473, 3432, 4030, 1805, 1591],
    &[2761, 2473, 3433, 4030, 1929, 1605],
    &[2765, 2473, 3434, 4030, 1930, 1591],
];

const ALL_PARAMETERS: u16 = 0;
const ALL_PARAMETER_DESCRIPTIONS: u16 = 1;
const MODULE_LIST: u16 = 2;
const GLOBAL_LEGAL_PARAMETERS: u16 = 67;
...
const PARAMETER_DETAILS: &[(&str, u16)] = &[
    ("ackermannization.eager", 357),
    ("ackermannization.inc_sat_backend", 358),
    ("ackermannization.sat_backend", 359),
    ("algebraic.factor", 337),
    ("algebraic.factor_max_prime", 338),
    ("algebraic.factor_num_primes", 339),
    ("algebraic.factor_search_size", 340),
    ("algebraic.min_mag", 341),
    ("algebraic.zero_accuracy", 342),
    ("auto_config", 68),
    ("combined_solver.ignore_solver1", 343),
    ("combined_solver.solver2_timeout", 344),
    ("combined_solver.solver2_unknown", 345),
    ("ctrl_c", 69),
    ("debug_ref_count", 70),
    ("dot_proof_file", 71),
    ("dump_models", 72),
    ("encoding", 73),
    ("fp.bmc.linear_unrolling_depth", 475),
    ("fp.datalog.all_or_nothing_deltas", 476),
    ("fp.datalog.check_relation", 477),
    ("fp.datalog.compile_with_widening", 478),
    ("fp.datalog.dbg_fpr_nonempty_relation_signature", 479),
    ("fp.datalog.default_relation", 480),
    ("fp.datalog.default_table", 481),
    ("fp.datalog.default_table_checked", 482),
    ("fp.datalog.default_table_checker", 483),
    ("fp.datalog.explanations_on_relation_level", 484),
    ("fp.datalog.generate_explanations", 485),
    ("fp.datalog.initial_restart_timeout", 486),
    ("fp.datalog.magic_sets_for_queries", 487),
    ("fp.datalog.output_profile", 488),
    ("fp.datalog.print.tuples", 489),
    ("fp.datalog.profile_timeout_milliseconds", 490),
    ("fp.datalog.similarity_compressor", 491),
    ("fp.datalog.similarity_compressor_threshold", 492),
    ("fp.datalog.subsumption", 493),
    ("fp.datalog.timeout", 494),
    ("fp.datalog.unbound_compressor", 495),
    ("fp.datalog.use_map_names", 496),
    ("fp.engine", 497),
    ("fp.generate_proof_trace", 498),
    ("fp.print_aig", 499),
    ("fp.print_answer", 500),
    ("fp.print_boogie_certificate", 501),
    ("fp.print_certificate", 502),
    ("fp.print_fixedpoint_extensions", 503),
    ("fp.print_low_level_smt2", 504),
    ("fp.print_statistics", 505),
    ("fp.print_with_variable_declarations", 506),
    ("fp.rlimit", 507),
    ("fp.spacer.arith.solver", 508),
    ("fp.spacer.blast_term_ite_inflation", 509),
    ("fp.spacer.ctp", 510),
    ("fp.spacer.dump_benchmarks", 511),
    ("fp.spacer.dump_threshold", 512),
    ("fp.spacer.elim_aux", 513),
    ("fp.spacer.eq_prop", 514),
    ("fp.spacer.expand_bnd", 515),
    ("fp.spacer.gg.concretize", 516),
    ("fp.spacer.gg.conjecture", 517),
    ("fp.spacer.gg.subsume", 518),
    ("fp.spacer.global", 519),
    ("fp.spacer.gpdr", 520),
    ("fp.spacer.gpdr.bfs", 521),
    ("fp.spacer.ground_pobs", 522),
    ("fp.spacer.iuc", 523),
    ("fp.spacer.iuc.arith", 524),
    ("fp.spacer.iuc.debug_proof", 525),
    ("fp.spacer.iuc.old_hyp_reducer", 526),
    ("fp.spacer.iuc.print_farkas_stats", 527),
    ("fp.spacer.iuc.split_farkas_literals", 528),
    ("fp.spacer.keep_proxy", 529),
    ("fp.spacer.logic", 530),
    ("fp.spacer.max_level", 531),
    ("fp.spacer.max_num_contexts", 532),
    ("fp.spacer.mbqi", 533),
    ("fp.spacer.min_level", 534),
    ("fp.spacer.native_mbp", 535),
    ("fp.spacer.order_children", 536),
    ("fp.spacer.p3.share_invariants", 537),
    ("fp.spacer.p3.share_lemmas", 538),
    ("fp.spacer.propagate", 539),
    ("fp.spacer.push_pob", 540),
    ("fp.spacer.push_pob_max_depth", 541),
    ("fp.spacer.q3", 542),
    ("fp.spacer.q3.instantiate", 543),
    ("fp.spacer.q3.qgen.normalize", 544),
    ("fp.spacer.q3.use_qgen", 545),
    ("fp.spacer.random_seed", 546),
    ("fp.spacer.reach_dnf", 547),
    ("fp.spacer.reset_pob_queue", 548),
    ("fp.spacer.restart_initial_threshold", 549),
    ("fp.spacer.restarts", 550),
    ("fp.spacer.simplify_lemmas_post", 551),
    ("fp.spacer.simplify_lemmas_pre", 552),
    ("fp.spacer.simplify_pob", 553),
    ("fp.spacer.trace_file", 554),
    ("fp.spacer.use_array_eq_generalizer", 555),
    ("fp.spacer.use_bg_invs", 556),
    ("fp.spacer.use_derivations", 557),
    ("fp.spacer.use_euf_gen", 558),
    ("fp.spacer.use_inc_clause", 559),
    ("fp.spacer.use_inductive_generalizer", 560),
    ("fp.spacer.use_iuc", 561),
    ("fp.spacer.use_lemma_as_cti", 562),
    ("fp.spacer.use_lim_num_gen", 563),
    ("fp.spacer.validate_lemmas", 564),
    ("fp.spacer.weak_abs", 565),
    ("fp.tab.selection", 566),
    ("fp.validate", 567),
    ("fp.xform.array_blast", 568),
    ("fp.xform.array_blast_full", 569),
    ("fp.xform.bit_blast", 570),
    ("fp.xform.coalesce_rules", 571),
    ("fp.xform.coi", 572),
    ("fp.xform.compress_unbound", 573),
    ("fp.xform.elim_term_ite", 574),
    ("fp.xform.elim_term_ite.inflation", 575),
    ("fp.xform.fix_unbound_vars", 576),
    ("fp.xform.inline_eager", 577),
    ("fp.xform.inline_linear", 578),
    ("fp.xform.inline_linear_branch", 579),
    ("fp.xform.instantiate_arrays", 580),
    ("fp.xform.instantiate_arrays.enforce", 581),
    ("fp.xform.instantiate_arrays.nb_quantifier", 582),
    ("fp.xform.instantiate_arrays.slice_technique", 583),
    ("fp.xform.instantiate_quantifiers", 584),
    ("fp.xform.magic", 585),
    ("fp.xform.quantify_arrays", 586),
    ("fp.xform.scale", 587),
    ("fp.xform.slice", 588),
    ("fp.xform.subsumption_checker", 589),
    ("fp.xform.tail_simplifier_pve", 590),
    ("fp.xform.transform_arrays", 591),
    ("fp.xform.unfold_rules", 592),
    ("lp.dio", 278),
    ("lp.dio_branching_period", 279),
    ("lp.dio_calls_period", 280),
    ("lp.dio_calls_period_decrease", 281),
    ("lp.dio_cuts_enable_gomory", 282),
    ("lp.dio_cuts_enable_hnf", 283),
    ("lp.dio_gomory_enable_period", 284),
    ("lp.dio_ignore_big_nums", 285),
    ("lp.dio_run_gcd", 286),
    ("lp.int_hammer_period", 287),
    ("lp.lcube", 288),
    ("lp.lcube_flips", 289),
    ("lp.random_hammers", 290),
    ("memory_high_watermark", 74),
    ("memory_high_watermark_mb", 75),
    ("memory_max_alloc_count", 76),
    ("memory_max_size", 77),
    ("model", 78),
    ("model.compact", 259),
    ("model.completion", 260),
    ("model.inline_def", 261),
    ("model.partial", 262),
    ("model.user_functions", 263),
    ("model.v1", 264),
    ("model.v2", 265),
    ("model_evaluator.array_as_stores", 352),
    ("model_evaluator.array_equalities", 353),
    ("model_evaluator.completion", 354),
    ("model_evaluator.max_memory", 355),
    ("model_evaluator.max_steps", 356),
    ("model_validate", 79),
    ("nlsat.add_all_coeffs", 360),
    ("nlsat.canonicalize", 361),
    ("nlsat.check_lemmas", 362),
    ("nlsat.dump_mathematica", 363),
    ("nlsat.factor", 364),
    ("nlsat.inline_vars", 365),
    ("nlsat.known_sat_assignment_file_name", 366),
    ("nlsat.lazy", 367),
    ("nlsat.log_lemma_smtrat", 368),
    ("nlsat.log_lemmas", 369),
    ("nlsat.lws", 370),
    ("nlsat.lws_spt_threshold", 371),
    ("nlsat.lws_witness_subs_disc", 372),
    ("nlsat.lws_witness_subs_lc", 373),
    ("nlsat.max_conflicts", 374),
    ("nlsat.max_memory", 375),
    ("nlsat.minimize_conflicts", 376),
    ("nlsat.randomize", 377),
    ("nlsat.reorder", 378),
    ("nlsat.seed", 379),
    ("nlsat.shuffle_vars", 380),
    ("nlsat.simple_check", 381),
    ("nlsat.simplify_conflicts", 382),
    ("nlsat.variable_ordering_strategy", 383),
    ("nlsat.zero_disc", 384),
    ("nnf.ignore_labels", 333),
    ("nnf.max_memory", 334),
    ("nnf.mode", 335),
    ("nnf.sk_hack", 336),
    ("opt.dump_benchmarks", 291),
    ("opt.dump_models", 292),
    ("opt.elim_01", 293),
    ("opt.enable_core_rotate", 294),
    ("opt.enable_lns", 295),
    ("opt.enable_sat", 296),
    ("opt.enable_sls", 297),
    ("opt.incremental", 298),
    ("opt.lns_conflicts", 299),
    ("opt.maxlex.enable", 300),
    ("opt.maxres.add_upper_bound_block", 301),
    ("opt.maxres.hill_climb", 302),
    ("opt.maxres.max_core_size", 303),
    ("opt.maxres.max_correction_set_size", 304),
    ("opt.maxres.max_num_cores", 305),
    ("opt.maxres.maximize_assignment", 306),
    ("opt.maxres.pivot_on_correction_set", 307),
    ("opt.maxres.wmax", 308),
    ("opt.maxsat_engine", 309),
    ("opt.optsmt_engine", 310),
    ("opt.pb.compile_equality", 311),
    ("opt.pp.neat", 312),
    ("opt.pp.wcnf", 313),
    ("opt.priority", 314),
    ("opt.rc2.totalizer", 315),
    ("opt.rlimit", 316),
    ("opt.solution_prefix", 317),
    ("opt.timeout", 318),
    ("parallel.ablate_backtracking", 319),
    ("parallel.conquer.backtrack_frequency", 320),
    ("parallel.conquer.batch_size", 321),
    ("parallel.conquer.delay", 322),
    ("parallel.conquer.restart.max", 323),
    ("parallel.core_minimize", 324),
    ("parallel.cube.lookahead", 325),
    ("parallel.enable", 326),
    ("parallel.num_bb_threads", 327),
    ("parallel.simplify.exp", 328),
    ("parallel.simplify.inprocess.max", 329),
    ("parallel.simplify.max_conflicts", 330),
    ("parallel.simplify.restart.max", 331),
    ("parallel.threads.max", 332),
    ("parser.error_for_visual_studio", 743),
    ("parser.ignore_bad_patterns", 744),
    ("parser.ignore_user_patterns", 745),
    ("pi.arith", 92),
    ("pi.arith_weight", 93),
    ("pi.avoid_skolems", 94),
    ("pi.block_loop_patterns", 95),
    ("pi.decompose_patterns", 96),
    ("pi.enabled", 97),
    ("pi.max_multi_patterns", 98),
    ("pi.non_nested_arith_weight", 99),
    ("pi.pull_quantifiers", 100),
    ("pi.use_database", 101),
    ("pi.warnings", 102),
    ("pp.bounded", 114),
    ("pp.bv_literals", 115),
    ("pp.bv_neg", 116),
    ("pp.decimal", 117),
    ("pp.decimal_precision", 118),
    ("pp.fixed_indent", 119),
    ("pp.flat_assoc", 120),
    ("pp.fp_real_literals", 121),
    ("pp.max_depth", 122),
    ("pp.max_indent", 123),
    ("pp.max_num_lines", 124),
    ("pp.max_ribbon", 125),
    ("pp.max_width", 126),
    ("pp.min_alias_size", 127),
    ("pp.no_lets", 128),
    ("pp.pretty_proof", 129),
    ("pp.simplify_implies", 130),
    ("pp.single_line", 131),
    ("proof", 80),
    ("rcf.clean_denominators", 346),
    ("rcf.inf_precision", 347),
    ("rcf.initial_precision", 348),
    ("rcf.lazy_algebraic_normalization", 349),
    ("rcf.max_precision", 350),
    ("rcf.use_prem", 351),
    ("rewriter.algebraic_number_evaluator", 416),
    ("rewriter.arith_ineq_lhs", 417),
    ("rewriter.arith_lhs", 418),
    ("rewriter.bit2bool", 419),
    ("rewriter.blast_distinct", 420),
    ("rewriter.blast_distinct_threshold", 421),
    ("rewriter.blast_eq_value", 422),
    ("rewriter.blast_select_store", 423),
    ("rewriter.bv_extract_prop", 424),
    ("rewriter.bv_ineq_consistency_test_max", 425),
    ("rewriter.bv_ite2id", 426),
    ("rewriter.bv_le2extract", 427),
    ("rewriter.bv_le_extra", 428),
    ("rewriter.bv_not_simpl", 429),
    ("rewriter.bv_sort_ac", 430),
    ("rewriter.cache_all", 431),
    ("rewriter.coalesce_chars", 432),
    ("rewriter.div0_ackermann_limit", 433),
    ("rewriter.elim_and", 434),
    ("rewriter.elim_ite", 435),
    ("rewriter.elim_rem", 436),
    ("rewriter.elim_sign_ext", 437),
    ("rewriter.elim_to_real", 438),
    ("rewriter.enable_der", 439),
    ("rewriter.eq2ineq", 440),
    ("rewriter.expand_nested_stores", 441),
    ("rewriter.expand_power", 442),
    ("rewriter.expand_select_ite", 443),
    ("rewriter.expand_select_store", 444),
    ("rewriter.expand_store_eq", 445),
    ("rewriter.expand_tan", 446),
    ("rewriter.flat", 447),
    ("rewriter.flat_and_or", 448),
    ("rewriter.gcd_rounding", 449),
    ("rewriter.hi_div0", 450),
    ("rewriter.hi_fp_unspecified", 451),
    ("rewriter.hoist_ite", 452),
    ("rewriter.hoist_mul", 453),
    ("rewriter.ignore_patterns_on_ground_qbody", 454),
    ("rewriter.ite_extra_rules", 455),
    ("rewriter.local_ctx", 456),
    ("rewriter.local_ctx_limit", 457),
    ("rewriter.max_degree", 458),
    ("rewriter.max_memory", 459),
    ("rewriter.max_steps", 460),
    ("rewriter.mul2concat", 461),
    ("rewriter.mul_to_power", 462),
    ("rewriter.pull_cheap_ite", 463),
    ("rewriter.push_ite_arith", 464),
    ("rewriter.push_ite_bv", 465),
    ("rewriter.push_to_real", 466),
    ("rewriter.rewrite_patterns", 467),
    ("rewriter.som", 468),
    ("rewriter.som_blowup", 469),
    ("rewriter.sort_disjunctions", 470),
    ("rewriter.sort_store", 471),
    ("rewriter.sort_sums", 472),
    ("rewriter.split_concat_eq", 473),
    ("rewriter.unfold_recursive_functions", 474),
    ("rlimit", 81),
    ("sat.abce", 132),
    ("sat.acce", 133),
    ("sat.anf", 134),
    ("sat.anf.delay", 135),
    ("sat.anf.exlin", 136),
    ("sat.asymm_branch", 137),
    ("sat.asymm_branch.all", 138),
    ("sat.asymm_branch.delay", 139),
    ("sat.asymm_branch.limit", 140),
    ("sat.asymm_branch.rounds", 141),
    ("sat.asymm_branch.sampled", 142),
    ("sat.ate", 143),
    ("sat.backtrack.conflicts", 144),
    ("sat.backtrack.scopes", 145),
    ("sat.bca", 146),
    ("sat.bce", 147),
    ("sat.bce_at", 148),
    ("sat.bce_delay", 149),
    ("sat.blocked_clause_limit", 150),
    ("sat.branching.anti_exploration", 151),
    ("sat.branching.heuristic", 152),
    ("sat.burst_search", 153),
    ("sat.cardinality.encoding", 154),
    ("sat.cardinality.solver", 155),
    ("sat.cce", 156),
    ("sat.core.minimize", 157),
    ("sat.core.minimize_partial", 158),
    ("sat.ddfw.init_clause_weight", 159),
    ("sat.ddfw.reinit_base", 160),
    ("sat.ddfw.restart_base", 161),
    ("sat.ddfw.threads", 162),
    ("sat.ddfw.use_reward_pct", 163),
    ("sat.ddfw_search", 164),
    ("sat.dimacs.core", 165),
    ("sat.drat.activity", 166),
    ("sat.drat.binary", 167),
    ("sat.drat.check_sat", 168),
    ("sat.drat.check_unsat", 169),
    ("sat.drat.disable", 170),
    ("sat.drat.file", 171),
    ("sat.dyn_sub_res", 172),
    ("sat.elim_vars", 173),
    ("sat.enable_pre_simplify", 174),
    ("sat.euf", 175),
    ("sat.force_cleanup", 176),
    ("sat.gc", 177),
    ("sat.gc.burst", 178),
    ("sat.gc.defrag", 179),
    ("sat.gc.increment", 180),
    ("sat.gc.initial", 181),
    ("sat.gc.k", 182),
    ("sat.gc.small_lbd", 183),
    ("sat.inprocess.max", 184),
    ("sat.inprocess.out", 185),
    ("sat.local_search", 186),
    ("sat.local_search_dbg_flips", 187),
    ("sat.local_search_mode", 188),
    ("sat.local_search_threads", 189),
    ("sat.lookahead.cube.cutoff", 190),
    ("sat.lookahead.cube.depth", 191),
    ("sat.lookahead.cube.fraction", 192),
    ("sat.lookahead.cube.freevars", 193),
    ("sat.lookahead.cube.psat.clause_base", 194),
    ("sat.lookahead.cube.psat.trigger", 195),
    ("sat.lookahead.cube.psat.var_exp", 196),
    ("sat.lookahead.delta_fraction", 197),
    ("sat.lookahead.double", 198),
    ("sat.lookahead.global_autarky", 199),
    ("sat.lookahead.preselect", 200),
    ("sat.lookahead.reward", 201),
    ("sat.lookahead.use_learned", 202),
    ("sat.lookahead_scores", 203),
    ("sat.lookahead_simplify", 204),
    ("sat.lookahead_simplify.bca", 205),
    ("sat.max_conflicts", 206),
    ("sat.max_memory", 207),
    ("sat.minimize_lemmas", 208),
    ("sat.override_incremental", 209),
    ("sat.pb.lemma_format", 210),
    ("sat.pb.min_arity", 211),
    ("sat.pb.resolve", 212),
    ("sat.pb.solver", 213),
    ("sat.phase", 214),
    ("sat.phase.sticky", 215),
    ("sat.prob_search", 216),
    ("sat.probing", 217),
    ("sat.probing_binary", 218),
    ("sat.probing_cache", 219),
    ("sat.probing_cache_limit", 220),
    ("sat.probing_limit", 221),
    ("sat.propagate.prefetch", 222),
    ("sat.random_freq", 223),
    ("sat.random_seed", 224),
    ("sat.reorder.activity_scale", 225),
    ("sat.reorder.base", 226),
    ("sat.reorder.itau", 227),
    ("sat.rephase.base", 228),
    ("sat.resolution.cls_cutoff1", 229),
    ("sat.resolution.cls_cutoff2", 230),
    ("sat.resolution.limit", 231),
    ("sat.resolution.lit_cutoff_range1", 232),
    ("sat.resolution.lit_cutoff_range2", 233),
    ("sat.resolution.lit_cutoff_range3", 234),
    ("sat.resolution.occ_cutoff", 235),
    ("sat.resolution.occ_cutoff_range1", 236),
    ("sat.resolution.occ_cutoff_range2", 237),
    ("sat.resolution.occ_cutoff_range3", 238),
    ("sat.restart", 239),
    ("sat.restart.emafastglue", 240),
    ("sat.restart.emaslowglue", 241),
    ("sat.restart.factor", 242),
    ("sat.restart.fast", 243),
    ("sat.restart.initial", 244),
    ("sat.restart.margin", 245),
    ("sat.restart.max", 246),
    ("sat.retain_blocked_clauses", 247),
    ("sat.scc", 248),
    ("sat.scc.tr", 249),
    ("sat.search.sat.conflicts", 250),
    ("sat.search.unsat.conflicts", 251),
    ("sat.simplify.delay", 252),
    ("sat.smt", 253),
    ("sat.smt.proof.check", 254),
    ("sat.subsumption", 255),
    ("sat.subsumption.limit", 256),
    ("sat.threads", 257),
    ("sat.variable_decay", 258),
    ("sls.arith_allow_plateau", 385),
    ("sls.arith_use_clausal_lookahead", 386),
    ("sls.arith_use_lookahead", 387),
    ("sls.bv_allow_rotation", 388),
    ("sls.bv_use_lookahead", 389),
    ("sls.bv_use_top_level_assertions", 390),
    ("sls.dt_axiomatic", 391),
    ("sls.early_prune", 392),
    ("sls.max_memory", 393),
    ("sls.max_repairs", 394),
    ("sls.max_restarts", 395),
    ("sls.paws_init", 396),
    ("sls.paws_sp", 397),
    ("sls.random_offset", 398),
    ("sls.random_seed", 399),
    ("sls.rescore", 400),
    ("sls.restart_base", 401),
    ("sls.restart_init", 402),
    ("sls.scale_unsat", 403),
    ("sls.str_update_strategy", 404),
    ("sls.track_unsat", 405),
    ("sls.vns_mc", 406),
    ("sls.vns_repick", 407),
    ("sls.walksat", 408),
    ("sls.walksat_repick", 409),
    ("sls.walksat_ucb", 410),
    ("sls.walksat_ucb_constant", 411),
    ("sls.walksat_ucb_forget", 412),
    ("sls.walksat_ucb_init", 413),
    ("sls.walksat_ucb_noise", 414),
    ("sls.wp", 415),
    ("smt.arith.auto_config_simplex", 593),
    ("smt.arith.bprop_on_pivoted_rows", 594),
    ("smt.arith.branch_cut_ratio", 595),
    ("smt.arith.dump_bound_lemmas", 596),
    ("smt.arith.dump_lemmas", 597),
    ("smt.arith.eager_eq_axioms", 598),
    ("smt.arith.enable_hnf", 599),
    ("smt.arith.epsilon", 600),
    ("smt.arith.greatest_error_pivot", 601),
    ("smt.arith.ignore_int", 602),
    ("smt.arith.int_eq_branch", 603),
    ("smt.arith.min", 604),
    ("smt.arith.nl", 605),
    ("smt.arith.nl.branching", 606),
    ("smt.arith.nl.cross_nested", 607),
    ("smt.arith.nl.delay", 608),
    ("smt.arith.nl.expensive_patching", 609),
    ("smt.arith.nl.expp", 610),
    ("smt.arith.nl.gr_q", 611),
    ("smt.arith.nl.grobner", 612),
    ("smt.arith.nl.grobner_adaptive", 613),
    ("smt.arith.nl.grobner_cnfl_to_report", 614),
    ("smt.arith.nl.grobner_eqs_growth", 615),
    ("smt.arith.nl.grobner_exp_delay", 616),
    ("smt.arith.nl.grobner_expand_terms", 617),
    ("smt.arith.nl.grobner_expr_degree_growth", 618),
    ("smt.arith.nl.grobner_expr_size_growth", 619),
    ("smt.arith.nl.grobner_frequency", 620),
    ("smt.arith.nl.grobner_gcd_test", 621),
    ("smt.arith.nl.grobner_max_simplified", 622),
    ("smt.arith.nl.grobner_propagate_quotients", 623),
    ("smt.arith.nl.grobner_row_length_limit", 624),
    ("smt.arith.nl.grobner_subs_fixed", 625),
    ("smt.arith.nl.horner", 626),
    ("smt.arith.nl.horner_frequency", 627),
    ("smt.arith.nl.horner_row_length_limit", 628),
    ("smt.arith.nl.horner_subs_fixed", 629),
    ("smt.arith.nl.log", 630),
    ("smt.arith.nl.monomial_binomial_sign", 631),
    ("smt.arith.nl.monomial_sandwich", 632),
    ("smt.arith.nl.monomial_sandwich.max_fanout", 633),
    ("smt.arith.nl.nra", 634),
    ("smt.arith.nl.nra_check_assignment", 635),
    ("smt.arith.nl.nra_check_assignment_max_fail", 636),
    ("smt.arith.nl.optimize_bounds", 637),
    ("smt.arith.nl.order", 638),
    ("smt.arith.nl.order.binomial_sign", 639),
    ("smt.arith.nl.propagate_linear_monomials", 640),
    ("smt.arith.nl.reduce_pseudo_linear", 641),
    ("smt.arith.nl.rounds", 642),
    ("smt.arith.nl.tangents", 643),
    ("smt.arith.nl.tangents.box_corners", 644),
    ("smt.arith.print_ext_var_names", 645),
    ("smt.arith.print_stats", 646),
    ("smt.arith.propagate_eqs", 647),
    ("smt.arith.propagation_mode", 648),
    ("smt.arith.random_initial_value", 649),
    ("smt.arith.rep_freq", 650),
    ("smt.arith.simplex_strategy", 651),
    ("smt.arith.solver", 652),
    ("smt.arith.validate", 653),
    ("smt.array.extensional", 654),
    ("smt.array.weak", 655),
    ("smt.auto_config", 656),
    ("smt.bound_simplifier", 657),
    ("smt.bv.delay", 658),
    ("smt.bv.enable_int2bv", 659),
    ("smt.bv.reflect", 660),
    ("smt.bv.size_reduce", 661),
    ("smt.bv.solver", 662),
    ("smt.bv.watch_diseq", 663),
    ("smt.candidate_models", 664),
    ("smt.case_split", 665),
    ("smt.clause_proof", 666),
    ("smt.core.extend_nonlocal_patterns", 667),
    ("smt.core.extend_patterns", 668),
    ("smt.core.extend_patterns.max_distance", 669),
    ("smt.core.minimize", 670),
    ("smt.core.validate", 671),
    ("smt.cube_depth", 672),
    ("smt.dack", 673),
    ("smt.dack.eq", 674),
    ("smt.dack.factor", 675),
    ("smt.dack.gc", 676),
    ("smt.dack.gc_inv_decay", 677),
    ("smt.dack.threshold", 678),
    ("smt.delay_units", 679),
    ("smt.delay_units_threshold", 680),
    ("smt.dt_lazy_splits", 681),
    ("smt.elim_unconstrained", 682),
    ("smt.ematching", 683),
    ("smt.ho_matching", 684),
    ("smt.ho_matching_bound", 685),
    ("smt.induction", 686),
    ("smt.lemma_gc_strategy", 687),
    ("smt.logic", 688),
    ("smt.macro_finder", 689),
    ("smt.max_conflicts", 690),
    ("smt.mbqi", 691),
    ("smt.mbqi.force_template", 692),
    ("smt.mbqi.id", 693),
    ("smt.mbqi.max_cexs", 694),
    ("smt.mbqi.max_cexs_incr", 695),
    ("smt.mbqi.max_iterations", 696),
    ("smt.mbqi.trace", 697),
    ("smt.pb.conflict_frequency", 698),
    ("smt.pb.learn_complements", 699),
    ("smt.phase_caching_off", 700),
    ("smt.phase_caching_on", 701),
    ("smt.phase_selection", 702),
    ("smt.propagate_values", 703),
    ("smt.pull_nested_quantifiers", 704),
    ("smt.q.lift_ite", 705),
    ("smt.q.lite", 706),
    ("smt.qi.cost", 707),
    ("smt.qi.eager_threshold", 708),
    ("smt.qi.lazy_threshold", 709),
    ("smt.qi.max_instances", 710),
    ("smt.qi.max_multi_patterns", 711),
    ("smt.qi.profile", 712),
    ("smt.qi.profile_freq", 713),
    ("smt.qi.quick_checker", 714),
    ("smt.qsat_use_qel", 715),
    ("smt.quasi_macros", 716),
    ("smt.random_seed", 717),
    ("smt.refine_inj_axioms", 718),
    ("smt.relevancy", 719),
    ("smt.restart.max", 720),
    ("smt.restart_factor", 721),
    ("smt.restart_strategy", 722),
    ("smt.restricted_quasi_macros", 723),
    ("smt.seq.max_unfolding", 724),
    ("smt.seq.min_unfolding", 725),
    ("smt.seq.regex_factorization_enabled", 726),
    ("smt.seq.regex_factorization_threshold", 727),
    ("smt.seq.split_w_len", 728),
    ("smt.seq.validate", 729),
    ("smt.sls.enable", 730),
    ("smt.sls.parallel", 731),
    ("smt.solve_eqs", 732),
    ("smt.solve_eqs.linear", 733),
    ("smt.solve_eqs.non_ground", 734),
    ("smt.string_solver", 735),
    ("smt.term_enumeration", 736),
    ("smt.theory_aware_branching", 737),
    ("smt.theory_case_split", 738),
    ("smt.threads", 739),
    ("smt.threads.cube_frequency", 740),
    ("smt.threads.max_conflicts", 741),
    ("smt.up.persist_clauses", 742),
    ("smtlib2_compliant", 82),
    ("solver.axioms2files", 266),
    ("solver.cancel_backup_file", 267),
    ("solver.instantiations2console", 268),
    ("solver.lemmas2console", 269),
    ("solver.proof.check", 270),
    ("solver.proof.check_rup", 271),
    ("solver.proof.log", 272),
    ("solver.proof.save", 273),
    ("solver.proof.trim", 274),
    ("solver.slice", 275),
    ("solver.smtlib2_log", 276),
    ("solver.timeout", 277),
    ("stats", 83),
    ("tactic.blast_term_ite.max_inflation", 103),
    ("tactic.blast_term_ite.max_steps", 104),
    ("tactic.default_tactic", 105),
    ("tactic.lia2card.max_ite_nesting", 106),
    ("tactic.lia2card.max_range", 107),
    ("tactic.propagate_values.max_rounds", 108),
    ("tactic.randomizer.seed", 109),
    ("tactic.solve_eqs.context_solve", 110),
    ("tactic.solve_eqs.ite_solver", 111),
    ("tactic.solve_eqs.max_occs", 112),
    ("tactic.solve_eqs.theory_solver", 113),
    ("timeout", 84),
    ("trace", 85),
    ("trace_file_name", 86),
    ("type_check", 87),
...
pub(crate) fn print_z3_version() {
    safe_println!("Z3 version 5.0.0 - 64 bit");
}
...
mod tests {
    ...
    #[test]
    fn exact_z3_500_parameter_database_is_closed() {
        let globals = PARAMETER_DETAILS
            .iter()
            .filter(|(name, _)| !name.contains('.'))
            .count();
        assert_eq!(globals, 24);
        assert_eq!(MODULE_TEXT.len(), 21);
        assert_eq!(MODULE_MARKDOWN.len(), 22);
        assert_eq!(PARAMETER_DETAILS.len(), 678);
        assert_eq!(PARAMETER_DETAILS.len() - globals, 654);
        assert_eq!(NULL_DEFAULT_PARAMETERS.len(), 13);
    }
...
/// The exact `Legal parameters are:` block z3 5.0.0 prints when `set-option`
...
/// Whether `name` is one of the 24 global parameters z3 5.0.0 recognizes.
///
...
/// Whether `module` is one of the 21 parameter modules z3 5.0.0 exposes.
///
...
/// real `(default: seq)`. Two of `smt`'s 150 parameters (`logic`, `mbqi.id`)

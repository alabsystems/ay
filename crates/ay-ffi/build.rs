...
//! Build script: embeds build provenance into ay-ffi.
//!
//! This keeps the FFI version surface aligned with the stamped build identity
//! exposed by the CLI and other consumers.

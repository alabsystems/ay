...
mod result_protocol;
use result_protocol::array_equality_propagation_conflict_result;
pub(super) use result_protocol::{
    assert_fixpoint_convergence, defer_non_local_result, forward_non_sat, triage_lia_result,

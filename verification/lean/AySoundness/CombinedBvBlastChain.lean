...
/-! Auto-generated by AY: bit-blast UNSAT for `(and (= (bvand (bvand a b) c) #b1) (= a #b0))`, grounded in the verified
...
structure Val where
  α : Nat → Bool
  respects_0 : α 4 = (α 1 && α 2)
  respects_1 : α 5 = (α 4 && α 3)
...
def original : List (Cid × Clause) := [(9, [5]), (10, [-1])]
def lemmas : List (Cid × Clause) := [(1, [-4, 1, 2]), (2, [-4, 1, -2]), (3, [-4, -1, 2]), (4, [4, -1, -2]), (5, [-5, 4, 3]), (6, [-5, 4, -3]), (7, [-5, -4, 3]), (8, [5, -4, -3])]
...
theorem lemmas_valid :
  ...
  rcases hcl with h | h | h | h | h | h | h | h
  · subst h; cases hv0 : m.α 1 <;> cases hv1 : m.α 2 <;> simp_all [clauseSat, litSat, atomVal, m.respects_0]
  · subst h; cases hv0 : m.α 1 <;> cases hv1 : m.α 2 <;> simp_all [clauseSat, litSat, atomVal, m.respects_0]
  · subst h; cases hv0 : m.α 1 <;> cases hv1 : m.α 2 <;> simp_all [clauseSat, litSat, atomVal, m.respects_0]
  · subst h; cases hv0 : m.α 1 <;> cases hv1 : m.α 2 <;> simp_all [clauseSat, litSat, atomVal, m.respects_0]
  · subst h; cases hv3 : m.α 4 <;> cases hv2 : m.α 3 <;> simp_all [clauseSat, litSat, atomVal, m.respects_1]
  · subst h; cases hv3 : m.α 4 <;> cases hv2 : m.α 3 <;> simp_all [clauseSat, litSat, atomVal, m.respects_1]
  · subst h; cases hv3 : m.α 4 <;> cases hv2 : m.α 3 <;> simp_all [clauseSat, litSat, atomVal, m.respects_1]
  · subst h; cases hv3 : m.α 4 <;> cases hv2 : m.α 3 <;> simp_all [clauseSat, litSat, atomVal, m.respects_1]
